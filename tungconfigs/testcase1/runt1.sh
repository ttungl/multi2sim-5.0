...
m2s --x86-sim detailed --x86-report tungconfigs/testcase1/pipeline_mm_mult_serial.out \
--mem-report tungconfigs/testcase1/mem_mm_mult_serial.out \
--x86-config tungconfigs/testcase1/x86_cpuconfig --net-config tungconfigs/testcase1/netconfig \
--net-max-cycles 1000000 --mem-config tungconfigs/testcase1/memconfig \
--x86-max-inst 1000 \
--net-report report_mm_mult_serial_8_netrunt1 ./mm_mult_serial/mm_mult_serial 8 
